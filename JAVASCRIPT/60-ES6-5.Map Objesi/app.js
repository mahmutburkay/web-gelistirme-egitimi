...
// const array = Array.from(map1);  //*  map ten array e çevirme
...
const myMap = new Map(array2);  //* array i al map e çevir

const myArray = Array.from(myMap);  //* map i tekrar array e çevir 
console.log(myArray)
